...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $config->templateUri; ?>css/globasa.css?02-01">
  ...
  <script src="<?php echo $config->siteUri; ?>assets/ipa.js?02-01"></script>
  <script src="<?php echo $config->siteUri; ?>assets/browse.js?02-01"></script>
